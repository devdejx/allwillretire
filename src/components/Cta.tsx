...
const Cta = () => {
  return <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        {/* Video container with videos stacked vertically */}
        <div className="absolute inset-0 w-full h-full flex flex-col overflow-hidden">
          ...
          <div className="w-full h-1/3 relative overflow-hidden">
            <iframe 
              ...
              className="absolute w-full h-[150%] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 object-cover" 
              title="Top Background Video"
            ></iframe>
          </div>
