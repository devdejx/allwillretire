  ...
  return <>
      <section className="py-24 relative overflow-hidden">
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          <div className="absolute inset-0 w-full h-full overflow-hidden border border-gold-500/30">
            ...
            <div className="absolute inset-0 border-2 border-gold-500/30 z-10"></div>
            ...
            <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-transparent via-gold-500/50 to-transparent z-10"></div>
            <div className="absolute right-0 top-0 bottom-0 w-1 bg-gradient-to-b from-transparent via-gold-500/50 to-transparent z-10"></div>
          </div>
        </div>
