  ...
  return (
    <>
      ...
      <section className="relative w-full h-screen">
        ...
        {/* Add gold border around the image - modified to fit better on mobile */}
        <div className="absolute inset-0 mx-4 my-4 md:mx-8 md:my-8 border-2 border-gold-500/80 shadow-[0_0_10px_3px_rgba(255,195,0,0.5)] rounded-md overflow-hidden z-0">
          <img 
