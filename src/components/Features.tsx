  ...
  return <section ref={sectionRef} id="features" className={`pt-0 text-white relative ${isFirstFeature ? "mt-0" : isSecondFeature ? "mt-0" : "-mt-12"} ${noBottomPadding ? "pb-0" : "pb-4"} -mb-2`}>
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="w-full h-full" style={{ position: 'relative' }}>
          <iframe 
            ref={playerRef}
            src="https://player.vimeo.com/video/1065963596?h=ff2bc9aa48&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479&amp;background=1&amp;muted=1&amp;loop=1&amp;autoplay=1&amp;quality=auto" 
            frameBorder="0" 
