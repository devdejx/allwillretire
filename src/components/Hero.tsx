...
const Hero = () => {
  ...
  return (
    <React.Fragment>
      ...
      <section className={`relative min-h-screen flex items-center ${isMobile ? 'pt-14' : 'pt-20'} overflow-hidden z-10`}>
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            <div className={`${isMobile ? 'h-8' : 'h-14'} mb-2`}></div>
            
            <h1 className={`${isMobile ? 'text-3xl leading-snug mt-14' : 'text-4xl md:text-6xl lg:text-7xl leading-tight'} mb-6 animate-fade-up tracking-tight`} style={{
              animationDelay: '0.2s',
